...
export class PointRelationService {
  ...
  public getMyPointsNumber(): Observable<Number> {

    const points = new BehaviorSubject(0);
    let pointCounter = 0;

    this.getMyStudentPoints().subscribe(pointsArray => {
      pointsArray.forEach(function (point) {
        pointCounter += Number(point.value);
        points.next(pointCounter);
      });
    });
    return points;
  }
  ...
  */
  public getMyStudentPoints1(groupId: string): Observable<Array<PointRelation>> {
    ...
    const ret: Array<PointRelation> = new Array<PointRelation>();
    const obj: Array<PointRelation> = new Array<PointRelation>();
    let count = 0; /* Este contador es para contar las veces que un elemento del array pointRelations no se copia en el array ret*/
    let count2 = 0; /* Este contador es para contar las veces que un elemento del array ret no se copia en el array obj*/
    let count3 = false; /* Este contador es para hacer el push del objeto si no se encuentra repetido en el array obj*/
    let count4 = true; /* Este contador es para hacer el push del objeto si no se encuentra repetido en el array obj*/
    let count5 = false;
    let count6 = 0;
    let count7 = 0;
    const numGroupid = parseFloat(groupId);
  ...
  public getMyStudentPoints3(groupId: string, studentId: string): Observable<Array<PointRelation>> {
    ...
    let count = 0; /* Este contador es para contar las veces que un elemento del array pointRelations no se copia en el array ret*/
    let count2 = 0; /* Este contador es para contar las veces que un elemento del array ret no se copia en el array obj*/
    let count3 = 0; /* Este contador es para hacer el push del objeto si no se encuentra repetido en el array obj*/
    let count4 = 0; /* Este contador es para hacer el push del objeto si no se encuentra repetido en el array obj*/
    const numGroupid = parseFloat(groupId);
    const numStudentid = parseFloat(studentId);
